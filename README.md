...
![Static Badge](https://img.shields.io/badge/Author-pjh456-4CAF50)
![Static Badge](https://img.shields.io/badge/Frontend-Electron-0091D5)
![Static Badge](https://img.shields.io/badge/Backend-Java-F4A300)
![Static Badge](https://img.shields.io/badge/Communication-RESTful%20API-E84A5F)
...
| Git           | 有就行，没有也行     |
| Electron      | 33.3.1       |
| Node.js       | 12.20.55 或更高 |
| Monaco Editor | 0.52.2  或更高  |
...
通过直接或间接配置 [``configs.json``](KrkrDataLoader/src/main/resources/configs.json) 来设置规则。
...
1. 直接按照上述规则描述所示，编辑 [``configs.json``](KrkrDataLoader/src/main/resources/configs.json) 来实现新规则。
2. 使用命令行工具，通过读取剧情文件并输入指令的方式，处理和保存配置文件，以实现新规则。
3. 使用 RESTful API，通过上传剧情文本文件或访问 API 来实现新规则。
