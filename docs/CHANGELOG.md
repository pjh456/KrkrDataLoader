## [0.2.8] -2025.2.2 **latest**

## Added
- 优化了项目文档的视觉效果，提高了项目文档的可读性。

## Changed
- 大幅修改了开发者文档的格式，转为主要使用表格来呈现。
...
## Fixed
- 修复了 KrkrUtils 使用路径加载时无法跨平台的问题。

## Deleted
- 移除了 `JsonPath` 中无用的 `isInRow` 属性和方法。
...
## Fixed
- 修复了 README.md 中英语开发者文档用中文描述索引的问题。
...
- 新增 JsonPath 类，用于表示 Json 文件中某一层级的内容。
